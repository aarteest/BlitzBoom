...
public class CharacterSelectDisplay : NetworkBehaviour
{
    ...
    [SerializeField] private Button copyButton; // Reference to the Copy Button
    ...
    public override void OnNetworkSpawn()
    {
        ...
        // Hook up the copy button to the CopyJoinCode method
    ...
    public override void OnNetworkDespawn()
    {
        ...
        copyButton.onClick.RemoveListener(CopyJoinCode);
    }
    ...
    {
        GUIUtility.systemCopyBuffer = HostManager.Instance.JoinCode; // Copies the join code to clipboard
        Debug.Log("Join Code copied to clipboard: " + HostManager.Instance.JoinCode);
    }
}
